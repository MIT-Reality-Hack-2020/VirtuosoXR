...
namespace MagicLeapTools
{
    ...
    public class FidgetSpinner : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _directManipulation.events.OnGrabBegin.AddListener(HandleTouchBegan);
            _directManipulation.events.OnDragUpdate.AddListener(HandleDragUpdate);
        }
        ...
        private void HandleTouchBegan(InteractionPoint point)
        {
            if (_directManipulation.activeInteractionPoints.Count == 1)
            {
                ...
                switch (_directManipulation.activeInteractionPoints[0].managedHand.Hand.HandType)
                {
