...
namespace MagicLeapTools
{
    public class TransmissionObject : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            //hooks:
            Transmission.Instance.events.OnPeerFound.AddListener(HandlePeerFound);
            Transmission.Instance.events.OnTransformSync.AddListener(HandleTransformSync);
            Transmission.Instance.events.OnOwnershipGained.AddListener(HandleOwnershipGained);
            Transmission.Instance.events.OnOwnershipTransferDenied.AddListener(HandleOwnershipTransferDenied);
        }
        ...
        private void OnDestroy()
        {
            ...
            {
                Transmission.Instance.events.OnPeerFound.RemoveListener(HandlePeerFound);
                Transmission.Instance.events.OnTransformSync.RemoveListener(HandleTransformSync);
                Transmission.Instance.events.OnOwnershipGained.RemoveListener(HandleOwnershipGained);
                Transmission.Instance.events.OnOwnershipTransferDenied.RemoveListener(HandleOwnershipTransferDenied);
            }
        }
