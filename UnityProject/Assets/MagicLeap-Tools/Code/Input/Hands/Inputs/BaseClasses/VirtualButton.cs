...
namespace MagicLeapTools
{
    public abstract class VirtualButton : MonoBehaviour
    {
        ...
        [Tooltip("A collection of UnityEvents that this button fires.")]
        ...
        private void UpdateProgress()
        {
            ...
            events.OnHoverUpdated?.Invoke(HoverPercentage);
            if (TouchPercentage >= 0)
            {
                events.OnPressUpdated?.Invoke(TouchPercentage);
            }
        }
