...
namespace MagicLeapTools
{
    ...
    public class PushButton : VirtualButton
    {
        ...
        protected virtual void Awake()
        {
            ...
            //hooks:
            events.OnPressUpdated.AddListener(HandlePressUpdated);
            events.OnHoverUpdated.AddListener(HandleHoverUpdated);
            events.OnPressed.AddListener(HandlePressed);
            events.OnReleased.AddListener(HandleReleased);
            events.OnTouchEnd.AddListener(HandleTouchEnd);
            events.OnHoverEnd.AddListener(HandleHoverEnd);
            events.OnCanceled.AddListener(HandleCanceled);
