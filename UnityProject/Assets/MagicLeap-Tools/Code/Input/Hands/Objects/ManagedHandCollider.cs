...
namespace MagicLeapTools
{
    public class ManagedHandCollider
    {
        ...
        public ManagedHandCollider(ManagedHand managedHand)
        {
            ...
            //creates:
            GameObject collider = new GameObject($"({managedHand.Hand.HandType}Collider)", typeof(SphereCollider), typeof(BoxCollider), typeof(Rigidbody));
            ...
            _handCollider.events.OnTriggerEntered.AddListener(HandleTriggerEnter);
            _handCollider.events.OnTriggerStayed.AddListener(HandleTriggerStay);
            _handCollider.events.OnTriggerExited.AddListener(HandleTriggerExit);
            _handCollider.events.OnCollisionEntered.AddListener(HandleCollisionEnter);
            _handCollider.events.OnCollisionStayed.AddListener(HandleCollisionStay);
            _handCollider.events.OnCollisionExited.AddListener(HandleCollisionExit);
