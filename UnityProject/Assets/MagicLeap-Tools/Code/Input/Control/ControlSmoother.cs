...
namespace MagicLeapTools
{
    public class ControlSmoother : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            controlInput.events.OnTriggerPressEnded.AddListener(HandleTriggerPressEnded);
        }

        private void OnDisable()
        {
            //unhooks:
            controlInput.events.OnTriggerPressBegan.RemoveListener(HandleTriggerPressBegan);
            controlInput.events.OnTriggerPressEnded.RemoveListener(HandleTriggerPressEnded);
        }
